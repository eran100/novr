...
[[ -f "$PLUGIN" ]] || { echo "ERROR: NOVR.dll was not produced."; exit 1; }
[[ -f "$PATCHER" ]] || { echo "ERROR: NOVR.Patcher.dll was not produced."; exit 1; }
[[ -d "$PAYLOAD" ]] || { echo "ERROR: CopyToGame payload was not produced."; exit 1; }
